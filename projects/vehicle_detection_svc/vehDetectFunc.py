...
def extract_features(imgs, color_space='RGB', spatial_size=(32, 32),
    ...
    for file in imgs:
        ...
        ##matplotlib image will read these in on a scale of 0 to 1, but cv2.imread() will scale them from 0 to 255.
        if('.png' in file):
            image = mpimg.imread(file)
            # png images are in range 0 to 1. Scaling it to 0 to 255 range
